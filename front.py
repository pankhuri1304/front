...
st.write('<meta name="viewport" content="width=device-width, initial-scale=1.0">', unsafe_allow_html=True)
...
with col1:
    st.write(
        "<center>" '<a href="https://isha-agarwal-19-summer-medalsummer-ch6etc.streamlit.app/" target="_blank"> <img src= "https://www.vrfitnessinsider.com/wp-content/uploads/2018/06/anigif_enhanced-buzz-4220-1343595880-0.gif" style="width:500px;height:250px;" > </a>',
        unsafe_allow_html=True)
with col2:
    st.markdown(
...
with col1:
    st.write(
        "<center>" '<a href="https://isha-agarwal-19-winter-medalwinter-spua7v.streamlit.app/", target="_blank"> <img src= "https://i.gifer.com/RSOq.gif" style="width:500px;height:250px;" > </a>',
        unsafe_allow_html=True)
with col2:
    st.markdown(
...
with col1:
    st.write(
        "<center>" '<a href="https://isha-agarwal-19-overall-medaloverall-ribyis.streamlit.app/", target="_blank"> <img src= "https://themarketingbirds.com/wp-content/uploads/2021/07/1627242520209.gif" style="width:500px;height:250px;" > </a>',
        unsafe_allow_html=True)
